...
struct MockInterpolatorReceiveVolumeData {
  struct Results {
    ...
    Mesh<3> mesh{};
    Variables<tmpl::list<gr::Tags::Lapse<DataVector>>> vars{};
  };
