 ...
 *
 * Identifiers for elements from multiple parallel components can be stored.
 * Each element is identified by an `observers::ArrayComponentId` and also needs
 * to provide the `std::string` that identifies it in the data file.
 */
